...
export default function Expander({ text, items, parentState }: { text: string, items: Array<any>, parentState: any }) {
    return (
        <Collapse onToggle={() => parentState.setState(() => { return { isCategoryFiltersOpen: !parentState.state.isCategoryFiltersOpen } })}>
            <CollapseHeader>
